...
////// Emissive:
                ...
                float2 node_1392 = float2(((_Nebula2XOffsetModifier*node_7847.g)+i.posWorld.r),(i.posWorld.g+(_Nebula2YOffsetModifier*node_7847.g)));
